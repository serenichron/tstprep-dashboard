...
>
	...
	<span class="inline-flex flex-col -my-px" aria-hidden="true">
		<svg width="7" height="5" viewBox="0 0 7 5" class="block {ascOn ? 'text-brand-green' : 'text-gray-300'}" fill="currentColor">
			<path d="M3.5 0 L7 5 L0 5 Z" />
		</svg>
		<svg width="7" height="5" viewBox="0 0 7 5" class="block {descOn ? 'text-brand-green' : 'text-gray-300'}" fill="currentColor">
